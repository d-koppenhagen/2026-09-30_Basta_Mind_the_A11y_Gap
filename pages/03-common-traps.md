...
<div class="col-span-2">
  <div class="w-95% ml-5 text-right">
    <ImageWithSource src="/a11y_dept_everywhere.jpg" alt="Meme: Buzz Lightyear zeigt Woody das Universum – A11y-Probleme, A11y-Probleme überall" source="via Imgflip" source-href="https://imgflip.com/i/ahxlzv" class="mt-7"/>
  </div>
</div>
